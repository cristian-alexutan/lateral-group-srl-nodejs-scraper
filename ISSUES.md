...
Acest proiect folosește [GitHub Issues](https://github.com/cristian-alexutan/lateral-group-srl-nodejs-scraper/issues) pentru a urmări munca.
...
Vezi [toate issue-urile](https://github.com/cristian-alexutan/lateral-group-srl-nodejs-scraper/issues).
