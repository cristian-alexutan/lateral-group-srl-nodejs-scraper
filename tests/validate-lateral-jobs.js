/**
 * Lateral Job Validator - Check and remove expired jobs
 *
 * Validates all Lateral jobs from peviitor API and deletes expired (404) ones from SOLR.
 * Run: node tests/validate-lateral-jobs.js
 */
...
async function main(args) {
  ...
  console.log("Lateral Job Validator");
  console.log("=".repeat(50));
